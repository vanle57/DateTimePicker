...
public class MainActivity extends Activity {
    ...
    ArrayList<JoinWeek>arrJob=new ArrayList<JoinWeek>();
    //Khai báo ArrayAdapter cho ListView
    ArrayAdapter<JoinWeek> adapter=null;
    ListView lvCv;
    Calendar cal;
    Date dateFinish;
    Date hourFinish;
    ...
    public void getFormWidgets()
    {
        ...
        adapter=new ArrayAdapter<JoinWeek>
                (this,
    ...
    public void processAddJob()
    {
        ...
        JoinWeek job=new JoinWeek(title, description, dateFinish, hourFinish);
        arrJob.add(job);
        adapter.notifyDataSetChanged();
